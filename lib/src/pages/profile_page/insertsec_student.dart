...
import 'package:nipat/src/pages/profile_page/editinsert.dart';
import 'package:nipat/src/pages/profile_page/editsec.dart';
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
          ...
          stream: Firestore.instance
              .collection('students').where('set', isEqualTo: widget.numbersec)
              .snapshots(),
          builder:
                    ...
                    return ListTile(
                      title: Text(
                        ...
                        style: TextStyle(color: Colors.black),
                          ...
                          onTap: (){
                  Navigator.push(context,MaterialPageRoute(builder: (context)=>EditinsertPage(
